...
public class livroDAO {
    ...
    public static boolean salvarLivro(String titulo, String isbn, int ano, int estoque, int autorId) {
        ...
        try (Connection conn = conexao.conectar();
            ...
            JOptionPane.showMessageDialog(null, "Erro ao salvar livro no banco: " + e.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
            return false;
        }
    }

    // Listar todos os livros cadastrados junto com o nome do Autor
    public static List<Object[]> listarLivros() {
        ...
        try (Connection conn = conexao.conectar();
            ...
            JOptionPane.showMessageDialog(null, "Erro ao carregar livros do banco: " + e.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
        }
